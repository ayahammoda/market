...
class _CategoryPageState extends State<CategoryPage> {
  ...
  CollectionReference usersRef = FirebaseFirestore.instance.collection(kCategoryCollection);
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(colors: [startc,endc],
                      begin: Alignment.topLeft,
                      end: Alignment.bottomRight,),
                          borderRadius: BorderRadius.circular(15),
                    ),
                    child: GridTile(
                      child: Center(child: Text(data[kCategoryName]
